  ...
  return (
    <div className="landing-page">
      ...
      <section className="stats-section my-xl">
        <div className="card max-w-3xl mx-auto flex flex-col md:flex-row justify-around text-center py-lg border-accent" style={{ display: 'flex', justifyContent: 'space-around', background: 'rgba(217, 70, 239, 0.03)' }}>
          <div>
      ...
      <section className="how-it-works my-xl max-w-3xl mx-auto">
        <h2 className="title-md text-center mb-xl">How ProofScholar Works</h2>
        <div className="space-y-md" style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          ...
          <div className="card flex items-start gap-md" style={{ display: 'flex', gap: '1.5rem', alignItems: 'flex-start' }}>
            <div className="bg-accent text-white rounded-full p-sm" style={{ background: 'var(--accent-gradient)', color: '#fff', padding: '0.75rem', borderRadius: '50%', boxShadow: '0 4px 15px rgba(217, 70, 239, 0.3)' }}>
              <User size={24} />
            </div>
            <div>
